...
from pyrate import process, configuration as cf
...
class ReferencePixelInputTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.params[pyrate.constants.REFNY] = REFNY
...
class LegacyEqualityTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.params[pyrate.constants.OUT_DIR] = tempfile.mkdtemp()
        self.params_alt_ref_frac = copy.copy(self.params)
        self.params_alt_ref_frac[pyrate.constants.REF_MIN_FRAC] = 0.5
        self.params_all_2s = copy.copy(self.params)
        self.params_all_2s[pyrate.constants.REFNX] = 2
        self.params_all_2s[pyrate.constants.REFNY] = 2
        self.params_chipsize_15 = copy.copy(self.params_all_2s)
        self.params_chipsize_15[pyrate.constants.REF_CHIP_SIZE] = 15
        self.params_all_1s = copy.copy(self.params)
        self.params_all_1s[pyrate.constants.REFNX] = 1
        self.params_all_1s[pyrate.constants.REFNY] = 1
        self.params_all_1s[pyrate.constants.REF_MIN_FRAC] = 0.7
    ...
    def test_small_test_data_ref_pixel(self):
        ...
        self.assertAlmostEqual(0.8, self.params[pyrate.constants.REF_MIN_FRAC])
    ...
    def test_small_test_data_ref_chipsize_15(self):
        ...
        self.assertAlmostEqual(0.5, self.params_alt_ref_frac[pyrate.constants.REF_MIN_FRAC])
    ...
    def test_small_test_data_ref_all_1(self):
        ...
        self.assertAlmostEqual(0.7, self.params_all_1s[pyrate.constants.REF_MIN_FRAC])
        self.assertEqual(1, self.params_all_1s[pyrate.constants.REFNX])
        self.assertEqual(1, self.params_all_1s[pyrate.constants.REFNY])
